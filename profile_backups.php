...
<body onload="checkActiveMessage('<?php echo $_SESSION['auth']['uid']; ?>'); loadRecommend('<?php echo $_SERVER['REQUEST_URI']; ?>');"> <!--  -->
	...
	<div class="container-item">
		<div style="">
			...
			<textarea style="width:80%;border-radius:5px;border:thin solid #ccc;resize:none;" rows="5" placeholder="What's on your mind..."></textarea>
		...
		<span class="user-stats">
			...
			<li><?php echo $stats['total_followed']; ?> following</li>110
		</span>
